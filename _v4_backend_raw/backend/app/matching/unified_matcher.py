...
from app.config import MATCH_WEIGHTS, ATTR_CATEGORY_MAP
from app.matching.eoicd_enricher import EnrichedQuery, _resolve_aliases, _get_synonym_lookup, _tokenize_name
from app.matching.text_matcher import TextMatcher
from app.models import HLRLabel, HLRRequirement, MatchCandidate
...
class UnifiedMatcher:
    ...
    def score_profile(
        ...
        """
        from app.matching.signal_profiler import SignalProfile  # noqa: F811
