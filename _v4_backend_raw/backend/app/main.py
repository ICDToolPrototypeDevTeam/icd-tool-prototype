...
from app.comparison.report_generator import generate_report, generate_reverse_report
from app.comparison.semantic_judge import judge_cases, judge_reverse_cases
...
from app.doc_generators.consensus_word_generator import generate_consensus_report as generate_consensus_word
...
def _cmd_analyze(args: argparse.Namespace) -> None:
    ...
    from app.pipeline import run_forward_pipeline
...
def _cmd_reverse_match(args: argparse.Namespace) -> None:
    ...
    if trace_dir:
        from app.pipeline import _match_reverse_with_trace
...
def _cmd_reverse_analyze(args: argparse.Namespace) -> None:
    ...
    from app.pipeline import run_reverse_pipeline
    from app.job_manager import job_manager
