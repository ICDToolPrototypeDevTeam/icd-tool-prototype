...
def parse_inputs(
    ...
    Args:
        ...
        eoicd_excel_paths: EoICD Excel 附件路径列表（本 Issue 暂不解析）
        sw_req_path: 软件高层需求文件路径
        job_id: 任务标识

    Returns:
        UnifiedInputPackage（包含 eoicd_chunks 与 software_requirements）
    """
    # 解析 EoICD 主文件为 chunk 列表（本 Issue 默认 1 个 chunk-001）
